...
The derivation of acclimated quantities Vcmax, Jmax, and $\xi$ are described in [Stocker et al., 2020](https://doi.org/10.5194/gmd-13-1545-2020). They can be used to calculate stomatal conductance $g_s$, leaf internal CO2 concentration $c_i$, and the assimilation rates $A_J$ and $A_C$ by simulataneously solving  Eqs. C1, 5, in [Stocker et al., 2020](https://doi.org/10.5194/gmd-13-1545-2020) and the standard FvCB equations for $A_J$ and $A_C$.
