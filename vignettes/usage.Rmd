...
Addendum: As of [issue #19](https://github.com/computationales/rpmodel/issues/19) (raised by David Orme), the values provided in Cai & Prentice (2020) are erroneous. And instead, the temperature response function for C4 should be `ftemp = -0.064 + 0.03 * tc - 0.000464 * tc^2`. This is now also implemented in rpmodel.
...
ggplot() +
  ...
  labs(x = expression(paste("Temperature (", degree, "C)")), y = expression(varphi),
       title = "Temperature dependence of C3 photosynthesis (BRC setup)",
...
ggplot() +
  ...
  xlim(0, 30) +
  labs(x = expression(paste("Temperature (", degree, "C)")), y = expression(varphi),
       title = "Temperature dependence of C4 photosynthesis (BRC setup)",
       subtitle = "Black: Stocker et al., 2020 | Blue: Cai & Prentice, 2020")
```
