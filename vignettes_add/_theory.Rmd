...
out_opt_ll_list <- purrr::map(
  as.list( vpd_vec ),
  ~wrap_calc_optimal_gs_vcmax_ll( 300, fapar, kphio, out_analytical$kmm, out_analytical$gammastar, out_analytical$ns_star, out_analytical$ca, ., beta, out_analytical$vcmax, out_analytical$gs )
  )
chi_vec_ll <- out_opt_ll_list %>% purrr::map_dbl("chi")

out_opt_jmax_list <- purrr::map(
  as.list( vpd_vec ),
  ~wrap_calc_optimal_gs_vcmax_jmax( 300, fapar, kphio, out_analytical$kmm, out_analytical$gammastar, out_analytical$ns_star, out_analytical$ca, ., beta, gamma, unitcost_root$par, out_analytical$vcmax, out_analytical$gs, out_analytical$vcmax )
  )
chi_vec_jmax <- out_opt_jmax_list %>% purrr::map_dbl("chi")
