...
#'
#' Calculates instantaneous scaling of rates, given acclimated capacities returned
#' by function \code{rpmodel}.
#'
...
#' respectively.
#' @return A list containing instantaneous rates calculated from acclimated photosyntetic capacities (Vcmax25,
#' Jmax25, "average" gs). This includes :
#' \itemize{
#'
#' \item \code{vcmax}
#' \item \code{jmax}
...
#'
inst_rpmodel <- function( x, tc, vpd, co2, fapar, ppfd, patm = NA, elv = NA, kphio, verbose = FALSE ){
  ...
  ## Parameters
  ##--------------------------------
  ## this parameter value must be the same as the one used in rpmodel. Should think of a better way
  ## to specify parameters that are "public" across the package.
